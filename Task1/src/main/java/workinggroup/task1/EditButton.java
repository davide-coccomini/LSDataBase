...
public class EditButton extends Button{
    private int row_Id;                 // id of the object in that row
    private UIController controller;    //controller, file UIController.java
    private int argument;               //quantity of the book
